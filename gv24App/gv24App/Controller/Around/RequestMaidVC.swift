...
//            self.labelAddress.text = maid?.address?.name
    ...
    private let titleTextField : UITextFieldButtomLine = {
    ...
    private let typeTextField : UITextFieldButtomLine = {
        let tF = UITextFieldButtomLine()
        tF.font = Fonts.by(name: .light, size: 15)
        tF.heightAnchor.constraint(equalToConstant: 40).isActive = true
    ...
    private let descriptionTextField : UITextFieldButtomLine = {
        let tF = UITextFieldButtomLine()
        tF.font = Fonts.by(name: .light, size: 15)
        tF.heightAnchor.constraint(equalToConstant: 40).isActive = true
    ...
    private let addressTextField : UITextFieldButtomLine = {
        let tF = UITextFieldButtomLine()
        tF.font = Fonts.by(name: .light, size: 15)
        tF.heightAnchor.constraint(equalToConstant: 40).isActive = true
    ...
    private let checkBoxTool : CheckBox = {
        let cb = CheckBox()
    ...
    private let radioButtonMoney : RadioButton = {
        let rb = RadioButton()
    ...
    private let radioButtonTime : RadioButton = {
        let rb = RadioButton()
    ...
    private let buttonDate : ButtonTitleValue = {
        let btn = ButtonTitleValue()
        btn.title = "Ngày làm việc"
        btn.valueString = "10/10/2017"
